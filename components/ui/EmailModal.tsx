...
const EmailModal: React.FC<EmailModalProps> = ({
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            // Only reset form after successful send
            setSubject('');
            setContent('');
            setSendToAll(false);
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                            ...
                            <button
                                ...
                                className="inline-flex items-center px-4 sm:px-6 py-2.5 text-sm font-semibold text-yellow-700 bg-yellow-50 border border-yellow-300 rounded-lg hover:bg-yellow-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 transition-all duration-200 disabled:opacity-50 shadow-sm gap-2"
                            >
